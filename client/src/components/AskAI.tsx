...
// pre-loaded with a prompt about HarvestAI. Pure client, no deps, dismissible.
...
const SUBJECT = "HarvestAI";
const PROMPT = "What is HarvestAI by TrueWeb (harvestai.com.ng) and how does it help businesses with AI-powered lead generation and data?";
const ACCENT = "#f5a623";
const ACCENT2 = "#b9770f";
  ...
  return (
    <div
      style={{
        ...
        background: "rgba(10,9,14,0.88)", backdropFilter: "blur(14px)",
        border: "1px solid rgba(255,255,255,0.12)", borderRadius: 14,
        boxShadow: "0 18px 50px -18px rgba(0,0,0,0.7)", padding: "12px 14px",
        color: "#f4f1ea", fontFamily: "ui-monospace, monospace",
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        >
          <span aria-hidden="true" style={{ display: "grid", placeItems: "center", width: 22, height: 22, borderRadius: 6, background: `linear-gradient(135deg,${ACCENT},${ACCENT2})`, color: "#100f0d", fontWeight: 700, fontSize: 13 }}>✦</span>
